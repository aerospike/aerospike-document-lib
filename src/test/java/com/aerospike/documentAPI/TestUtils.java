...
public class TestUtils {
    ...
    public static boolean jsonEquals(Object object1, Object object2){
        if((object1 instanceof Map) && (object2 instanceof Map)) return mapEquals((Map)object1,(Map)object2);
        else if((object1 instanceof List) && (object2 instanceof List)) return listEquals((List)object1,(List)object2);
        else return object1.toString().equals(object2.toString());
    }

    @Test
    /**
     * Checkt that our jsonEquals function works correctly
     */
    public void testMapEquals() throws IOException {
    ...
    private static String jsonToString(Object o){
        if(o instanceof Map) return jsonMapToString((Map<String,Object>)o);
        else if(o instanceof List) return jsonListToString((List)o);
        else if(o instanceof String) return String.format("\"%s\"",o);
    ...
    private static String jsonMapToString(Map<String,Object> map){
        ...
        List<String> stringRepresentations = new Vector<String>();
