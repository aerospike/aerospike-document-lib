...
public class DocumentAPITest {
    ...
    public void testPositivePathRetrieval() throws IOException,
        ...
        documentClient.put(TestConstants.TEST_AEROSPIKE_KEY, jsonAsMap);
        ...
        jsonPath = "$";
        objectFromDB = documentClient.get(TestConstants.TEST_AEROSPIKE_KEY,jsonPath);
    ...
    JsonPathParser.JsonParseException, AerospikeDocumentClient.AerospikeDocumentClientException{
        ...
        putValue = 77;
        documentClient.put(TestConstants.TEST_AEROSPIKE_KEY, jsonPath,putValue);
        objectFromDB = documentClient.get(TestConstants.TEST_AEROSPIKE_KEY,jsonPath);
    ...
    public void testPositiveAppend() throws IOException,
        ...
        putValue = 83;
        documentClient.append(TestConstants.TEST_AEROSPIKE_KEY, jsonPath, putValue);
        appendedList = ((List)documentClient.get(TestConstants.TEST_AEROSPIKE_KEY, jsonPath));
    ...
    public void testNegativeAppend() throws IOException,
        ...
        try{
            documentClient.append(TestConstants.TEST_AEROSPIKE_KEY, jsonPath, putValue);
            Assert.fail("AerospikeDocumentClient.KeytNotFoundException should have been thrown");
        }
        catch(AerospikeDocumentClient.KeyNotFoundException e){}
    ...
    public void testPositiveDelete() throws IOException,
        ...
        // Delete a primitive using a map reference
        jsonPath = "$.example4.key10.key11";
        originalObject = documentClient.get(TestConstants.TEST_AEROSPIKE_KEY, jsonPath);
        // Check the original object exists
        Assert.assertTrue(originalObject instanceof String);
        documentClient.delete(TestConstants.TEST_AEROSPIKE_KEY, jsonPath);
        deletedObjectRead = documentClient.get(TestConstants.TEST_AEROSPIKE_KEY, jsonPath);
